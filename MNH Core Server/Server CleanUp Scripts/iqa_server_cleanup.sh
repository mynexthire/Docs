...
if [[ $ARG == *"java -jar /home/ubuntu/CurrentProjects/trunk/SQSCore/target/SQSCore.jar"* ]] && ! [[ $ARG == *"sudo"*  ]] ; then
...
echo "Waiting for Tomcat to warm-up[1 minute]";
for i in {1..120}
do
  echo -n -e ".";
  sleep 0.5
...
echo ""
echo "Starting QR...";
sudo java -jar /home/ubuntu/CurrentProjects/trunk/SQSCore/target/SQSCore.jar & disown
echo "Started QR...";
